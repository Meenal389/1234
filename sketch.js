...
function setup() {
  ...
  ground = new Ground(displayWidth / 2, displayHeight / 2 + 250, displayWidth, 2)
...
function draw() {
  ...
  if (gameState === "level1") {
    ...
    if (life <= 0) {
      console.log("gameState lose for level 1");
      gameState = "lose";
    }
  ...
  if (gameState === "lose") {
    clear()
    sea.visible = false;
    console.log("reached lose state");
